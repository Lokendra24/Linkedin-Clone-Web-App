...
import { getCurrentPostUser, removePost, updatePostData } from '../firebase/firebase'
...
function PostCard({element,userId,userName,currUserEmail}) {
  ...
  const EditPostOnClick=()=>{
    updatePostData(element.id,updatedValue)
    setOpen(false)
  }
